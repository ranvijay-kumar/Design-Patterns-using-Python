...
class CardGame(ABC):
    ...
    def combat(self, c1_index, c2_index):
        first_creature = self.creatures[c1_index]
        second_creature = self.creatures[c2_index]
        self.hit(first_creature, second_creature)
        self.hit(second_creature, first_creature)
        first_alive = first_creature.health > 0
        second_alive = second_creature.health > 0
